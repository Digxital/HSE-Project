...
router.post('/users', authenticateToken, async (req, res) => {
  try {
    ...
    // Return user data with temporary password (will be sent via email)
    res.status(201).json({
      ...
      temporaryPassword: password, // Only returned once for email delivery
      created: true
    });
