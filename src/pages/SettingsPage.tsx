      ...
      <div className={`transition-all duration-300 ${
        ...
        <main className="p-4 md:p-6 lg:p-8 bg-[#fffaf5] dark:bg-[#0D0D0D] transition-colors min-h-screen">
          <div className="max-w-3xl">
            ...
            <div className="mb-8">
              <h3 className="text-base font-semibold text-gray-900 dark:text-white mb-1">Notification</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">Choose how you want to receive updates.</p>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between px-4 py-3.5 bg-white dark:bg-[#121212] rounded-lg border border-gray-100 dark:border-gray-700">
                  <span className="text-sm text-gray-700 dark:text-gray-300">Receive report notifications</span>
                  <ToggleSwitch 
                ...
                <div className="flex items-center justify-between px-4 py-3.5 bg-white dark:bg-[#121212] rounded-lg border border-gray-100 dark:border-gray-700">
                  <span className="text-sm text-gray-700 dark:text-gray-300">Receive action updates</span>
                  <ToggleSwitch 
            ...
            <div className="pt-4">
              <button
                ...
                className="w-full py-3 px-4 border-2 border-red-400 dark:border-red-600 text-red-500 dark:text-red-400 rounded-lg font-medium hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 dark:focus:ring-offset-[#0D0D0D]"
              >
                Log out
              </button>
            </div>
